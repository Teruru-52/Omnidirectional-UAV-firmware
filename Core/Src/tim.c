...
/* USER CODE BEGIN 1 */
Motor motor1 = {ENABLE, &htim3, TIM_CHANNEL_3, TIM_CHANNEL_4};
Motor motor2 = {ENABLE, &htim4, TIM_CHANNEL_1, TIM_CHANNEL_2};
Motor motor3 = {ENABLE, &htim3, TIM_CHANNEL_1, TIM_CHANNEL_2};
Motor motor4 = {ENABLE, &htim2, TIM_CHANNEL_3, TIM_CHANNEL_4};
Motor motor5 = {ENABLE, &htim8, TIM_CHANNEL_1, TIM_CHANNEL_2};
Motor motor6 = {ENABLE, &htim4, TIM_CHANNEL_3, TIM_CHANNEL_4};
...
{
  if (HAL_TIM_PWM_Start(motor->htim, motor->CHANNEL_1) != HAL_OK)
  {
    Error_Handler();
  }
  if (HAL_TIM_PWM_Start(motor->htim, motor->CHANNEL_2) != HAL_OK)
  {
    Error_Handler();
  }
  motor->OutputPWM = ENABLE;
}
...
void PWM_Stop(Motor *motor)
{
  ...
  if (HAL_TIM_PWM_Stop(motor->htim, motor->CHANNEL_2) != HAL_OK)
  {
    Error_Handler();
  }
