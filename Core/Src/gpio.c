...
/*----------------------------------------------------------------------------*/
/* USER CODE BEGIN 1 */
GPIO_Value USER_LED1 = {LED1_GPIO_Port, LED1_Pin};
GPIO_Value USER_LED2 = {LED2_GPIO_Port, LED2_Pin};
GPIO_Value USER_LED3 = {LED3_GPIO_Port, LED3_Pin};
GPIO_Value USER_LED4 = {LED4_GPIO_Port, LED4_Pin};
