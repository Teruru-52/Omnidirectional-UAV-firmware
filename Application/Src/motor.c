...
{
    PWM_Update(motor1, motor_input->duty[0]);
    PWM_Update(motor2, motor_input->duty[1]);
    PWM_Update(motor3, motor_input->duty[2]);
    PWM_Update(motor4, motor_input->duty[3]);
    PWM_Update(motor5, motor_input->duty[4]);
    PWM_Update(motor6, motor_input->duty[5]);
    PWM_Update(motor7, motor_input->duty[6]);
    PWM_Update(motor8, motor_input->duty[7]);
}
